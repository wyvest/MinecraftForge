...
public class BiomeDictionary {
     ...
     * @param types the type to register the biome as
    ...
    public static Type[] getTypesForBiome(BiomeGenBase biome) {
        ...
        if (biomeList[biome.biomeID] != null) {
            return biomeList[biome.biomeID].typeList.toArray(new Type[0]);
        }
    ...
    private static Type[] listSubTags(Type... types) {
        List<Type> subTags = new ArrayList<>();
        ...
        return subTags.toArray(new Type[0]);
    }
