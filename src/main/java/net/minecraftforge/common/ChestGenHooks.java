...
public class ChestGenHooks {
    ...
    public void removeItem(ItemStack item) {
        contents.removeIf(cont -> item.isItemEqual(cont.theItemId) || (item.getItemDamage() == OreDictionary.WILDCARD_VALUE && item.getItem() == cont.theItemId.getItem()));
    }
    ...
    public ItemStack getOneItem(Random rand) {
        WeightedRandomChestContent item = WeightedRandom.getRandomItem(rand, getItems(rand));
