...
public class B3DLoader implements ICustomModelLoader {
    ...
    public IModel loadModel(ResourceLocation modelLocation) throws IOException {
        ...
        if (!(model.getRoot().getKind() instanceof Mesh)) {
            return new ModelWrapper(modelLocation, model, ImmutableSet.of(), 1);
        }
        return new ModelWrapper(modelLocation, model, ImmutableSet.of(model.getRoot().getName()), 1);
    }
    ...
    public static class B3DMeshLocation extends ResourceLocation {
        ...
        public boolean equals(Object obj) {
            ...
            if (mesh == null) {
                return other.mesh == null;
            } else return mesh.equals(other.mesh);
        }
    }
