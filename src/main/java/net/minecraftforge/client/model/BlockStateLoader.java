...
public class BlockStateLoader {
    ...
    public static ModelBlockDefinition load(Reader reader, final Gson vanillaGSON) {
        try {
            ...
            if (marker.forge_marker == 1) { // Version 1
        ...
        public IModel process(IModel base, ModelLoader loader) {
            ...
            for (Entry<String, SubModel> entry : parts.entrySet()) {
                ...
                try {
                    ...
                    FMLLog.warning("Unable to load block sub-model: '" + part.getModelLocation() /*+ "\' for variant: \'" + parent*/ + "': " + e);
                ...
                models.put(entry.getKey(), Pair.of(runModelHooks(model, part.smooth, part.gui3d, part.getTextures(), part.getCustomData()), partState));
            }
