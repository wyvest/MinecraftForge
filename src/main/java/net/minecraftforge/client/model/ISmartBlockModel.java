...
public interface ISmartBlockModel extends IBakedModel {
    ...
    abstract class Wrapper implements ISmartBlockModel, IFlexibleBakedModel {
    ...
    abstract class PerspectiveWrapper extends Wrapper implements IPerspectiveAwareModel {
