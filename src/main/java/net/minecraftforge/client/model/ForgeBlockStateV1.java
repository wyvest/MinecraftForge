                        ...
                        switch (transform) {
                            ...
                            case "forge:default-block": {
                                TRSRTransformation thirdperson = TRSRTransformation.blockCenterToCorner(new TRSRTransformation(
                                    ...
                                    null));
                                ret.state = Optional.of(new SimpleModelState(ImmutableMap.of(TransformType.THIRD_PERSON, thirdperson)));
                                break;
                            }
                            case "forge:default-item": {
                                TRSRTransformation thirdperson = TRSRTransformation.blockCenterToCorner(new TRSRTransformation(
                                ...
                                TRSRTransformation firstperson = TRSRTransformation.blockCenterToCorner(new TRSRTransformation(
                                    ...
                                    null));
                                ret.state = Optional.of(new SimpleModelState(ImmutableMap.of(TransformType.THIRD_PERSON, thirdperson, TransformType.FIRST_PERSON, firstperson)));
                                break;
                            }
                            case "forge:default-tool": {
                                TRSRTransformation thirdperson = TRSRTransformation.blockCenterToCorner(new TRSRTransformation(
