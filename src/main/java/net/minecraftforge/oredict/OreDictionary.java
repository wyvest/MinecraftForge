...
public class OreDictionary {
    ...
    private static final List<List<ItemStack>> idToStack = Lists.newArrayList();
    private static final List<List<ItemStack>> idToStackUn = Lists.newArrayList();
    ...
    public static void initVanillaEntries() {
        ...
        List<IRecipe> recipesToAdd = new ArrayList<>();
        ...
        for (IRecipe obj : recipes) {
            if (obj instanceof ShapedRecipes) {
                ...
                if (containsMatch(true, recipe.recipeItems.toArray(new ItemStack[0]), replaceStacks)) {
