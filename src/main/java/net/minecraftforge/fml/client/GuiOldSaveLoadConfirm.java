...
public class GuiOldSaveLoadConfirm extends GuiYesNo implements GuiYesNoCallback {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRendererObj, "There may be problems updating it to this version", this.width / 2, 70, 16777215);
        this.drawCenteredString(this.fontRendererObj, String.format("FML will save a zip to %s", zip.getName()), this.width / 2, 90, 16777215);
        this.drawCenteredString(this.fontRendererObj, "Do you wish to continue loading?", this.width / 2, 110, 16777215);
        int k;
