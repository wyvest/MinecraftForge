 ...
 * 2. Receive Server Hello. Send custom-channel registration. Send Client Hello. Send our mod list. Move to WAITINGFORSERVERDATA state.
 * 3. Receive server mod list. Send ack if acceptable, else send back an exit error. Receive server IDs. Move to COMPLETE state. Send ack.
 *
 * @author cpw
 */
