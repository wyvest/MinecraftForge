...
public class EventBus implements IEventExceptionHandler {
    ...
    private final KEventBus kEventBus = new KEventBus(new LMFInvoker(), e -> System.err.println("An exception occurred in a method: " + e.getMessage()));
    ...
    public void register(Object target) {
        if (ForgeModContainer.useKevinsEventBus) {
            kEventBus.register(target);
            return;
        }
