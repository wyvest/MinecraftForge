...
public class EntityRegistry {
    ...
    private final Map<String, EntityList.EntityEggInfo> entityEggs = Maps.newHashMap();
    private final Map<String, EntityList.EntityEggInfo> entityEggsUn = Collections.unmodifiableMap(entityEggs);
    ...
    private EntityRegistry() {
        ...
        for (Integer id : EntityList.idToClassMapping.keySet()) {
